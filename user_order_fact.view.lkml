include: "ec_essai3.model.lkml"  # car il y a un explore_source dans cette vue

view: user_order_facts {
  derived_table: {
    explore_source: order_items {
      column: user_id {}
      column: lifetime_orders {field: order_items.NombreCommandes}
      column: lifetime_revenue {field: order_items.PrixVenteTotal}
      column: first_order {}
      column: latest_order {}
      column: number_of_distinct_months_with_orders {field: order_items.NombreMois}
    }
    datagroup_trigger: ec_essai3_default_datagroup
  }
